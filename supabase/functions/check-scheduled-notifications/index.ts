...
// const TWILIO_PHONE_NUMBER = '+12188453968';
...
//       tls: true,
//       auth: {
//         username: 'niyogisubizothierryjoy@gmail.com',
//         password: 'bdlofdhcaqpmpsbn',
//       },
//     },
//   });
...
//   try {
//     await client.send({
//       from: 'DSPA(R) LTD <niyogisubizothierryjoy@gmail.com>',
//       to,
//       subject,
//       content: body,
//     });
...
//       try {
//         // Send email if email field is populated
...
//           await sendSMS(notification.phone, notification.description);
//         }
...
//       to:to,
//       cc:[
//         'dspa.rw@gmail.com', // First CC email
//         'tjbsaved@dspa.rw', // Second CC email
//       ],
//       subject,
//       html: fullBody,
      
//     });
//     console.log(`Email sent to ${to} (CC: dspa.rw@gmail.com, tjbsaved@dspa.rw)`);
//   } catch (error) {
//     console.error(`Failed to send email to ${to}:`, error);
//     throw error;
//   } finally {
...
//     return signatureData?.signature_html || null;
//   } catch (error) {
//     console.error('Error fetching signature:', error);
//     return null;
//   }
